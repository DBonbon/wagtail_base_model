"""
Django settings for emuseum project.
...
WSGI_APPLICATION = 'emuseum.wsgi.application'
...
# allauth configurations, more at https://django-allauth.readthedocs.io/en/latest/configuration.html
#
# LOGIN_URL = '/login/'
# LOGIN_REDIRECT_URL = '/'
