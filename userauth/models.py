...
class CustomUser(AbstractUser):
    display_name = models.CharField(null=True, blank=True, verbose_name=_("Display name"), max_length=30, help_text=_("Will be shown e.g. when commenting"))
    ...
    """ set profile.html as our default landing page after a new user has been created."""
